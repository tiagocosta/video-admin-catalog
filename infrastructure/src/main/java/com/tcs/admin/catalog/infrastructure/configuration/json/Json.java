package com.tcs.admin.catalog.infrastructure.configuration.json;
...
public enum Json {
    ...
    private final ObjectMapper mapper = new Jackson2ObjectMapperBuilder()
            ...
            .modules(new JavaTimeModule(), new Jdk8Module(), afterBBurnerModule())
            .propertyNamingStrategy(PropertyNamingStrategies.SNAKE_CASE)
            .build();

    private AfterburnerModule afterBBurnerModule() {
